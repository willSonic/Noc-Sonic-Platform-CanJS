  ...
  async.waterfall([
    ...
    function (error, callback) {
      if (error && error.code === 'ENOENT') {
    	console.log("got here error got here uploadDir ="+uploadDir);
  ...
  function put(file, callback) {
    ...
    async.waterfall([
      ...
      function (name, callback) {
        fs.mkdir(path.join(uploadDir, file.updatePath), '0755', function () {

          var tempLocation = file.path
            , destPath = path.join(uploadDir,  file.updatePath, file.name)
